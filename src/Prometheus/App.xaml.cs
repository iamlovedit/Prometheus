...
namespace Prometheus
{
    public partial class App : PrismApplication
    {
        ...
        protected override void RegisterTypes(IContainerRegistry containerRegistry)
        {
            ...
            containerRegistry.RegisterSingleton<IExternalLinkService, ExternalLinkService>();
            ...
            containerRegistry.RegisterSingleton<ILeagueClientLauncher, LeagueClientLauncher>();
            ...
            containerRegistry.RegisterSingleton<ILcuCompanionSettings,
                LcuCompanionSettings>();
